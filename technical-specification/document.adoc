...
:comment: ### Technical Specification template
:comment: ### This template is based on ISO/TS 17755-2:2020(en) standard preview provided in https://www.iso.org/obp/ui/#iso:std:iso:ts:17755:-2:ed-1:v1:en
:comment: ### Empty-value attributes are shown here for description purposes and do not apply to this particular standard (ISO/TS 17755-2:2020). Feel free to remove any attribute that don't apply to your particular case.
...
:title-intro-en: Fire safety
:title-main-en: Statistical data collection
:title-part-en: Vocabulary
:title-intro-fr: Sécurité incendie
:title-main-fr: Collecte des données statistiques
:title-part-fr: Vocabulaire
...
:library-ics: 01.040.13,13.220.20
...
For Technical Specification (TS), possible stages are:
...
For Technical Specification (TS), possible substages are:
