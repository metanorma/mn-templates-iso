...
:comment: ### International Workshop Agreement (IWA) template
:comment: ### This template is based on IWA 30-1:2019(en) standard preview provided in https://www.iso.org/obp/ui/#iso:std:iso:iwa:30:-1:ed-1:v1:en
...
:title-intro-en: 
:title-main-en: Competence of standards professionals
:title-part-en: In companies
:title-intro-fr: 
:title-main-fr: 
:title-part-fr:
