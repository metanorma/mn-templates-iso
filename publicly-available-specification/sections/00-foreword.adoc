...
This document was prepared by Technical Committee ISO/{technical-committee-type} _{technical-committee-number}_, _{technical-committee}_, Subcommittee _{subcommittee-type}_ _{subcommittee-number}_, _{subcommittee}_.
