...
Propose new project (PWI) / Proposal registed (NP) / Project registed (WD) / Committee draft registered (CD) / Final draft under publication (IS): 00
Proposal under review/ballot/study (PWI,NP,WD,CD): 20
